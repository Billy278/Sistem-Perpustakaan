                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div style="display: flex;">
                                        <a target="_blank" href="expor_excel.php" class="btn btn-danger" style="font-size: 16px;">EXPORT KE EXCEL</a>
                                    </div>
                                    <div class="col-lg-4" style="float: right;">
                                        ...
                                        if (isset($_GET['cari'])) {
                                            ...
                                            $cari = $_GET['cari'];
                                            $data = mysqli_query($koneksi, "SELECT * fROM tb_pengembalian where nama_peminjam like '%" . $cari . "%' OR id_kembali like '%" . $cari . "%' OR kelas like '%" . $cari . "%' OR kd_buku like '%" . $cari . "%' OR judul_buku like '%" . $cari . "%' OR kategori like '%" . $cari . "%' OR jumlah like '%" . $cari . "%' OR tanggal_pinjam like '%" . $cari . "%' OR tanggal_kembali like '%" . $cari . "%' OR denda like '%" . $cari . "%'");
                                        } else {
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="hapus.php?id=<?= $kembali['id_kembali'] ?>" class="btn btn-danger " style="margin-bottom: 1px;" onclick="return confirm('Anda Yakin ingin menghapus data pengembalian ?')">Hapus</a>
