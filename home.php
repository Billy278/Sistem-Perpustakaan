...
$buku = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM tb_buku");
$total = mysqli_fetch_assoc($buku);
$pinjam = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM tb_pinjam");
$totalpinjam = mysqli_fetch_assoc($pinjam);
$kembali = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM tb_pengembalian");
$totalkembali = mysqli_fetch_assoc($kembali);
$admin = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM admin");
$totaladmin = mysqli_fetch_assoc($admin);
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <marquee scrollamount="15">
                            <h1 class="h3 mb-0 text-gray-800" style="font-weight:bold; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Sistem Peminjaman Buku SMA KATOLIK 1 KABANJAHE</h1>
                        </marquee>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Data Buku</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $total['total']; ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Data Peminjaman</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalpinjam['total']; ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalkembali['total']; ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Admin</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totaladmin['total']; ?></div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img src="img/gambar9.JPG" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/gambar8.JPG" class="d-block w-100" alt="...">
                                </div>
