                        ...
                        <div class="col-lg">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Table Data Peminjaman</h6>
                                </div><br>
                                    ...
                                    <div class="card-body">
                                        <div class="col-lg-4" style="float: right;">
                                            ...
                                            if (isset($_GET['cari'])) {
                                                ...
                                                $cari = $_GET['cari'];
                                                $query = mysqli_query($koneksi, "SELECT * fROM tb_pinjam where nama like '%" . $cari . "%' OR id_pinjam like '%" . $cari . "%' OR kelas like '%" . $cari . "%' OR kd_buku like '%" . $cari . "%' OR judul_buku like '%" . $cari . "%' OR kategori like '%" . $cari . "%' OR jumlah like '%" . $cari . "%' OR tanggal_pinjam like '%" . $cari . "%'");
                                            } else {
                                                $query = mysqli_query($koneksi, "SELECT * FROM tb_pinjam");
                                            }
                                            ...
                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="overflow: auto;">
                                                <thead style="text-align: center;">
                                                    <tr>
                                                        ...
                                                        <th style="vertical-align: middle !important;">Tanggal Pinjam</th>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center;">
                                                                <a href="edit_pinjam.php?id=<?= $pinjam['id_pinjam'] ?>" class="btn btn-primary" style="margin-bottom: 1px;">Edit</a>
                                                                <a href="hapus.php?id=<?= $pinjam['id_pinjam'] ?>" class="btn btn-danger" style="margin-bottom: 1px;" onclick="return confirm('Anda Yakin ingin menghapus data peminjaman ?')">Hapus</a>
                                                                <a href="../datakembali/pengembalian.php?id=<?= $pinjam['id_pinjam'] ?>" class="btn btn-success" style="margin-bottom: 1px;">Pengembalian</a>
